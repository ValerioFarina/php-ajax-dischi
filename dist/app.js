...
$(document).ready(function () {
  ...
  if ($('#ajax-version').length) {
    ...
    getGenres(); // and we get all the albums (in the order in which they appear in the file albums.php)
  ...
  $("select.genres, select.year").change(function () {
    ...
    $(".albums").empty(); // finally, we get the albums that match the selected genre and order
  ...
  function getAlbums() {
    ...
    var selectedOrder = $('select.year').val(); // then, we make the ajax request (using the genre and the order selected as parameters)
    ...
    $.ajax({
      ...
      success: function success(albums) {
        albums.forEach(function (album) {
          ...
          var albumHtml = albumTemplate(placeholders); // then, we append the album's card to the albums' container
  ...
  function getGenres() {
    ...
    var genreHtml = $('#genre-template').html(); // we compile genreHtml in order to get the function genreTemplate
